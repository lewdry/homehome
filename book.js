...
const books = [
  { id: 'frankenstein', title: 'Frankenstein; or, The Modern Prometheus', author: 'Mary Shelley', file: '/homehome/books/frankenstein.txt' },
  { id: 'thirtyninesteps', title: 'The Thirty-Nine Steps', author: 'John Buchan', file: '/homehome/books/thirtyninesteps.txt' },
  { id: 'littlewomen', title: 'Little Women', author: 'Louisa May Alcott', file: '/homehome/books/littlewomen.txt' },
  { id: 'janeeyre', title: 'Jane Eyre', author: 'Charlotte Brontë', file: '/homehome/books/janeeyre.txt' },
  { id: 'treasureisland', title: 'Treasure Island', author: 'Robert Louis Stevenson', file: '/homehome/books/treasureisland.txt' },
  { id: 'yellowwallpaper', title: 'The Yellow Wallpaper', author: 'Charlotte Perkins Gilman', file: '/homehome/books/yellowwallpaper.txt' },
  { id: 'awakening', title: 'The Awakening', author: 'Kate Chopin', file: '/homehome/books/awakening.txt' },
  { id: 'mobydick', title: 'Moby-Dick; or, The Whale', author: 'Herman Melville', file: '/homehome/books/mobydick.txt' },
  { id: 'rubaiyat', title: 'The Rubaiyat of Omar Khayyam', author: 'Omar Khayyam', file: '/homehome/books/rubaiyat.txt' },
  { id: 'aroundtheworld', title: 'Around the World in Eighty Days', author: 'Jules Verne', file: '/homehome/books/aroundtheworld.txt' },
  { id: 'callofcthulhu', title: 'The Call of Cthulhu', author: 'H. P. Lovecraft', file: '/homehome/books/callofcthulhu.txt' },
  { id: 'prideandprejudice', title: 'Pride and Prejudice', author: 'Jane Austen', file: '/homehome/books/prideandprejudice.txt' },
  { id: 'middlemarch', title: 'Middlemarch', author: 'George Eliot', file: '/homehome/books/middlemarch.txt' },
  { id: 'beowulf', title: 'Beowulf', author: 'Unknown', file: '/homehome/books/beowulf.txt' },
  { id: 'enchantedapril', title: 'The Enchanted April', author: 'Elizabeth Von Arnim', file: '/homehome/books/enchantedapril.txt' },
  { id: 'metamorphosis', title: 'Metamorphosis', author: 'Franz Kafka', file: '/homehome/books/metamorphosis.txt' },
  { id: 'roomwithaview', title: 'A Room with a View', author: 'E. M. Forster', file: '/homehome/books/roomwithaview.txt' },
  { id: 'greatgatsby', title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', file: '/homehome/books/greatgatsby.txt' },
  { id: 'anneofgreengables', title: 'Anne of Green Gables', author: 'L. M. Montgomery', file: '/homehome/books/anneofgreengables.txt' },
  { id: 'dubliners', title: 'Dubliners', author: 'James Joyce', file: '/homehome/books/dubliners.txt' },
  { id: 'bookoftea', title: 'The Book of Tea', author: 'Kakuzo Okakura', file: '/homehome/books/bookoftea.txt' },
  { id: 'gulliverstravels', title: 'Gulliver\'s Travels', author: 'Jonathan Swift', file: '/homehome/books/gulliverstravels.txt' },
  { id: 'mrsspringfragrance', title: 'Mrs. Spring Fragrance', author: 'Sui Sin Far', file: '/homehome/books/mrsspringfragrance.txt' },
  { id: 'opioneers', title: 'O Pioneers!', author: 'Willa Cather', file: '/homehome/books/opioneers.txt' },
  { id: 'goldenthreshold', title: 'The Golden Threshold', author: 'Sarojini Naidu', file: '/homehome/books/goldenthreshold.txt' },
  { id: 'shipsthatpass', title: 'Ships That Pass In The Night', author: 'Beatrice Harraden', file: '/homehome/books/shipsthatpass.txt' },
  { id: 'meditations', title: 'Meditations', author: 'Marcus Aurelius', file: '/homehome/books/meditations.txt' },
  { id: 'timemachine', title: 'The Time Machine', author: 'H. G. Wells', file: '/homehome/books/timemachine.txt' },
  { id: 'wutheringheights', title: 'Wuthering Heights', author: 'Emily Brontë', file: '/homehome/books/wutheringheights.txt' },
  { id: 'poemsandsongs', title: 'Poems and Songs of Robert Burns', author: 'Robert Burns', file: '/homehome/books/poemsandsongs.txt' },
  { id: 'secretgarden', title: 'The Secret Garden', author: 'Frances Hodgson Burnett', file: '/homehome/books/secretgarden.txt' },
  { id: 'heidi', title: 'Heidi', author: 'Johanna Spyri', file: '/homehome/books/heidi.txt' },
  { id: 'junglebook', title: 'The Jungle Book', author: 'Rudyard Kipling', file: '/homehome/books/junglebook.txt' },
  { id: 'peterpan', title: 'Peter Pan', author: 'J. M. Barrie', file: '/homehome/books/peterpan.txt' },
  { id: 'aliceinwonderland', title: 'Alice\'s Adventures in Wonderland', author: 'Lewis Carroll', file: '/homehome/books/aliceinwonderland.txt' },
  { id: 'peterrabbit', title: 'The Tale of Peter Rabbit', author: 'Beatrix Potter', file: '/homehome/books/peterrabbit.txt' },
  { id: 'blackbeauty', title: 'Black Beauty', author: 'Anna Sewell', file: '/homehome/books/blackbeauty.txt' },
  { id: 'railwaychildren', title: 'The Railway Children', author: 'E. Nesbit', file: '/homehome/books/railwaychildren.txt' },
  { id: 'winniethepooh', title: 'Winnie-the-Pooh', author: 'A. A. Milne', file: '/homehome/books/winniethepooh.txt' },
  { id: 'velveteenrabbit', title: 'The Velveteen Rabbit', author: 'Margery Williams Bianco', file: '/homehome/books/velveteenrabbit.txt' }, 
  // Add new books here
];
